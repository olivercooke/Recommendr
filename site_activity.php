<?php
  include('session.php');
   ...
   $recentsql = "SELECT film.poster, film.title, filmuser.userID, filmuser.filmID, filmuser.rating FROM filmuser INNER JOIN film ON filmuser.filmID = film.filmID ORDER BY timestamp DESC LIMIT 18;";
